...
import { 
  Container, Text, Group, Stack, Avatar, 
  Button, TextInput, Title, Badge, Divider, LoadingOverlay, 
  FileButton, ActionIcon, Tabs, SimpleGrid, 
...
// Component con quản lý toàn bộ Form cấu hình & Cài đặt chi tiết
function ProfileFormContent({ 
  ...
  // States cho tab Hồ sơ giảng dạy (Bio, Bằng cấp, Chứng chỉ, Giải thưởng)
  ...
  return (
    <>
      ...
      <div className={classes.rightCard}>
        <Tabs value={activeTab} onChange={onTabChange} color="copper" variant="outline">
          <Tabs.List mb="xl">
      ...
      >
        <Stack gap="xl">
          <Group gap="lg">
            <Avatar src={profile.account?.avatarUrl} size={80} radius={80} color="copper">
